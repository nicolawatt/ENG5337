        ...
        if probe.connected:
            ...
            if newHIL:
                ...
                if newDownCam:
                    ...
                    forSpd, turnSpd = line2SpdMap.send((col, 0.4, 0.4)) #kP, kD
                    
                    #If robot oscillates/wobbles: Reduce kP, increase kD
                    #If robot responds slowly: Increase kP
                    #If robot overshoots turns: Increase kD
                    #Suggested tuning sequence: Try kP=0.5, kD=0.1, then adjust
                    #---------------------------------------------------------#
